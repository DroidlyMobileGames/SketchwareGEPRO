...
public class LogicClickListener implements View.OnClickListener {
    ...
    public LogicClickListener(LogicEditorActivity logicEditor) {
        ...
        for (ProjectFileBean projectFileBean : jC.b(logicEditor.B).b()) {
            //DNA MOBILE EDIT this won't list the Gameview or Main activities as we don't need to use these classes
            if (projectFileBean.getActivityName().contains("Activity")
